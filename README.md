...
*140 guides · last updated 2026-09-11*
...
- [Traefik Reverse Proxy and the Docker '502 Bad Gateway' Mysticism](docker/Traefik-Reverse-Proxy-and-the-Docker-502-Bad-Gateway-Mysticism.md) · [↗ valtersit.com](https://www.valtersit.com/guides/docker/Traefik-Reverse-Proxy-and-the-Docker-502-Bad-Gateway-Mysticism/)
- [Why Caddy Is My Favorite Reverse Proxy in 2025](docker/why-caddy-reverse-proxy.md) · [↗ valtersit.com](https://www.valtersit.com/why-caddy-is-my-favorite-reverse-proxy-in-2025/)
- [Why Your Docker Containers Are a Ticking Time Bomb (Root vs Non-Root)](docker/Why-Your-Docker-Containers-Are-a-Ticking-Time-Bomb-Root-vs-Non-Root.md) · [↗ valtersit.com](https://www.valtersit.com/guides/docker/Why-Your-Docker-Containers-Are-a-Ticking-Time-Bomb-Root-vs-Non-Root/)
- [Your Containers Are Bloated, Insecure Garbage. Let's Fix That with Distroless.](docker/your-containers-are-bloated-insecure-garbage-lets-fix-that-with-distroless.md) · [↗ valtersit.com](https://www.valtersit.com/guides/docker/your-containers-are-bloated-insecure-garbage-lets-fix-that-with-distroless/)
...
- [The .env Delusion: Why Your Docker Environment Variables are Leaking Secrets](kubernetes/The-env-Delusion- Why-Your-Docker-Environment-Variables-are-Leaking-Secrets.md) · [↗ valtersit.com](https://www.valtersit.com/guides/kubernetes/The-env-Delusion- Why-Your-Docker-Environment-Variables-are-Leaking-Secrets/)
- [What Is Rancher? The DevOps Superpower You Didn't Know You Needed](kubernetes/rancher-devops.md) · [↗ valtersit.com](https://www.valtersit.com/what-is-rancher-the-devops-superpower-you-didnt-know-you-needed/)

## 🦊 GitLab CI/CD

- [Ansible: If Your Playbook Isn't Idempotent, You're Doing it Wrong](gitlab/Ansible-If_Your_Playbook_Isnt_Idempotent_Youre_Doing_it_Wrong.md) · [↗ valtersit.com](https://www.valtersit.com/guides/gitlab/Ansible-If_Your_Playbook_Isnt_Idempotent_Youre_Doing_it_Wrong/)
- [Beyond .env: Managing Production Secrets Without Getting Hacked](gitlab/Beyond_env-Managing_Production_Secrets_Without_Getting_Hacked.md) · [↗ valtersit.com](https://www.valtersit.com/guides/gitlab/Beyond_env-Managing_Production_Secrets_Without_Getting_Hacked/)
...
- [GitLab Runners: Docker vs Kubernetes Executors Guide](gitlab/gitlab-runners-docker-vs-kubernetes-executors-guide.md) · [↗ valtersit.com](https://www.valtersit.com/guides/gitlab/gitlab-runners-docker-vs-kubernetes-executors-guide/)
...
- [Stop Paying for GitHub Actions: The Ultimate GitLab Self-Hosted Runner Migration Guide](gitlab/github-to-gitlab-migration.md) · [↗ valtersit.com](https://www.valtersit.com/stop-paying-for-github-actions-gitlab-self-hosted-runner-migration/)
- [Terraform State: One Corrupted File to Bring Down Your Entire Cloud](gitlab/Terraform_State-One_Corrupted_File_to_Bring_Down_Your_Entire _Cloud.md) · [↗ valtersit.com](https://www.valtersit.com/guides/gitlab/Terraform_State-One_Corrupted_File_to_Bring_Down_Your_Entire _Cloud/)
- [The Automated Testing Illusion: Why 100% Code Coverage is a Lie](gitlab/The_Automated_Testing_Illusion-Why_100_Code_Coverage_is_a_Lie.md) · [↗ valtersit.com](https://www.valtersit.com/guides/gitlab/The_Automated_Testing_Illusion-Why_100_Code_Coverage_is_a_Lie/)
...
- [High Availability Web Hosting: Why Your Panel Can't Actually Do It](hosting/High_Availability_Web_Hosting-Why_Your_Panel_Cant_Actually_Do_It.md) · [↗ valtersit.com](https://www.valtersit.com/guides/hosting/High_Availability_Web_Hosting-Why_Your_Panel_Cant_Actually_Do_It/)
- [Imunify360 vs. BitNinja: Are You Buying Protection or Wasting CPU Cycles?](hosting/Imunify360_vs_BitNinja-Are_You_Buying_Protection_or_Wasting_CPU_Cycles.md) · [↗ valtersit.com](https://www.valtersit.com/guides/hosting/Imunify360_vs_BitNinja-Are_You_Buying_Protection_or_Wasting_CPU_Cycles/)
- [Is It Worth Starting a Web Hosting Business in Q4 2025? The Honest Outlook](hosting/starting-web-hosting-business-2025.md) · [↗ valtersit.com](https://www.valtersit.com/is-it-worth-starting-a-web-hosting-business-in-q4-2025-the-honest-outlook/)
...
- [The SaaS Hosting Revolution: Why RunCloud, Forge, and Ploi are Winning](hosting/The_SaaS_Hosting_Revolution-Why_RunCloud_Forge_and_Ploi_are_Winning.md) · [↗ valtersit.com](https://www.valtersit.com/guides/hosting/The_SaaS_Hosting_Revolution-Why_RunCloud_Forge_and_Ploi_are_Winning/)
- [The cPanel Monopoly: How Private Equity Killed the Web Hosting Industry](hosting/The-cPanel-Monopoly-How-Private-Equity-Killed-the-Web-Hosting-Industry.md) · [↗ valtersit.com](https://www.valtersit.com/guides/hosting/The-cPanel-Monopoly-How-Private-Equity-Killed-the-Web-Hosting-Industry/)
- [WHMCS in 2025: The Ultimate Automation Tool for Hosting Businesses](hosting/whmcs-automation-2025.md) · [↗ valtersit.com](https://www.valtersit.com/whmcs-in-2025-the-ultimate-automation-tool-for-hosting-businesses/)
- [WHMCS vs. WiseCP: Why Billing Automation is a Necessary Evil](hosting/WHMCS-vs-WiseCP-Why-Billing-Automation-is-a-Necessary-Evil.md) · [↗ valtersit.com](https://www.valtersit.com/guides/hosting/WHMCS-vs-WiseCP-Why-Billing-Automation-is-a-Necessary-Evil/)
- [Why Zone.eu is the Top Choice for Affordable and Reliable Web Hosting](hosting/why-zone-eu-hosting.md) · [↗ valtersit.com](https://www.valtersit.com/why-zone-eu-is-the-top-choice-for-affordable-and-reliable-web-hosting/)
- [aaPanel and ISPConfig: The True Cost of Free Open-Source Panels](hosting/aaPanel_and_ISPConfig-The_True_Cost_of_Free_Open-Source_Panels.md) · [↗ valtersit.com](https://www.valtersit.com/guides/hosting/aaPanel_and_ISPConfig-The_True_Cost_of_Free_Open-Source_Panels/)
- [cPanel in 2025: Still the King of Hosting, or Time to Move On?](hosting/cpanel-in-2025.md) · [↗ valtersit.com](https://www.valtersit.com/cpanel-in-2025-still-the-king-of-hosting-or-time-to-move-on/)
...
- [Proxy vs VPN: Stop Confusing Privacy with Security](networking/Proxy-vs-VPN-Stop_Confusing_Privacy_with_Security.md) · [↗ valtersit.com](https://www.valtersit.com/guides/networking/Proxy-vs-VPN-Stop_Confusing_Privacy_with_Security/)
- [SSH Tunneling: The Swiss Army Knife of Networking You're Not Using](networking/SSH_Tunneling-The_Swiss_Army_Knife_of_Networking_Youre_Not_Using.md) · [↗ valtersit.com](https://www.valtersit.com/guides/networking/SSH_Tunneling-The_Swiss_Army_Knife_of_Networking_Youre_Not_Using/)
- [Site-to-Site IPsec: Connecting Offices Without Losing Your Mind](networking/Site-to-Site-IPsec-Connecting_Offices_Without_Losing_Your-Mind.md) · [↗ valtersit.com](https://www.valtersit.com/guides/networking/Site-to-Site-IPsec-Connecting_Offices_Without_Losing_Your-Mind/)
- [Split Tunneling: Performance vs Security in the Remote Work Era](networking/Split-Tunneling-Performance_vs_Security_in_the_Remote_Work_Era.md) · [↗ valtersit.com](https://www.valtersit.com/guides/networking/Split-Tunneling-Performance_vs_Security_in_the_Remote_Work_Era/)
- [Tailscale & ZeroTier: Why You're Fighting CGNAT and Losing](networking/Tailscale_ZeroTier-Why_Youre_Fighting_CGNAT-and-Losing.md) · [↗ valtersit.com](https://www.valtersit.com/guides/networking/Tailscale_ZeroTier-Why_Youre_Fighting_CGNAT-and-Losing/)
- [The MTU Nightmare: Why Your VPN Connection is Fragmenting to Death](networking/The-MTU-Nightmare-Why_Your_VPN_Connection_is_Fragmenting_to_Death.md) · [↗ valtersit.com](https://www.valtersit.com/guides/networking/The-MTU-Nightmare-Why_Your_VPN_Connection_is_Fragmenting_to_Death/)
- [VLAN Segmentation: Because Your 'Smart' Toaster is a Moron (and a Security Risk)](networking/vlan-segmentation-because-your-smart-toaster-is-a-moron-and-a-security-risk.md) · [↗ valtersit.com](https://www.valtersit.com/guides/networking/vlan-segmentation-because-your-smart-toaster-is-a-moron-and-a-security-risk/)
- [VLAN Segmentation: Securing IoT Devices from the Main Network](networking/vlan-segmentation-securing-iot-devices-from-the-main-network.md) · [↗ valtersit.com](https://www.valtersit.com/guides/networking/vlan-segmentation-securing-iot-devices-from-the-main-network/)
- [VLAN Segmentation: Why Your Smart Fridge Shouldn't Talk to Your File Server](networking/VLAN_Segmentation-Why_Your_Smart_Fridge_Shouldn-t_Talk_to_Your_File-Server.md) · [↗ valtersit.com](https://www.valtersit.com/guides/networking/VLAN_Segmentation-Why_Your_Smart_Fridge_Shouldn-t_Talk_to_Your_File-Server/)
...
- [The INT Limit: How to Hard-Crash Your Database at 2.1 Billion Rows](databases/The_INT_Limit-How_to_Hard-Crash_Your_Database_at_2-1_Billion_Rows.md) · [↗ valtersit.com](https://www.valtersit.com/guides/databases/The_INT_Limit-How_to_Hard-Crash_Your_Database_at_2-1_Billion_Rows/)
- [The Redis SAVE Command: How to Accidentally DDoS Your Own Application](databases/The-Redis-SAVE-Command-How-to-Accidentally-DDoS-Your-Own-Application.md) · [↗ valtersit.com](https://www.valtersit.com/guides/databases/The-Redis-SAVE-Command-How-to-Accidentally-DDoS-Your-Own-Application/)
- [The pg_hba.conf 'Trust' Trap: How to Give Your PostgreSQL Database Away for Free](databases/The-pg_hba_conf-Trust-Trap-How-to-Give-Your-PostgreSQL-Database-Away-for-Free.md) · [↗ valtersit.com](https://www.valtersit.com/guides/databases/The-pg_hba_conf-Trust-Trap-How-to-Give-Your-PostgreSQL-Database-Away-for-Free/)
- [You Need to Start Learning MySQL Right Now!](databases/mysql-setup-guide.md) · [↗ valtersit.com](https://www.valtersit.com/you-need-to-start-learning-mysql-right-now/)
- [ZFS Deduplication: The Fastest Way to Murder Your Server's RAM](databases/ZFS-Deduplication-The-Fastest-Way-to-Murder-Your-Servers-RAM.md) · [↗ valtersit.com](https://www.valtersit.com/guides/databases/ZFS-Deduplication-The-Fastest-Way-to-Murder-Your-Servers-RAM/)
- [ZFS Deep Dive: Data Integrity and ARC Management for Sysadmins](databases/zfs-deep-dive-data-integrity-and-arc-management-for-sysadmins.md) · [↗ valtersit.com](https://www.valtersit.com/guides/databases/zfs-deep-dive-data-integrity-and-arc-management-for-sysadmins/)

## 🔐 Cybersecurity

- [AppArmor and seccomp Profiles: Restricting Container System Calls](security/apparmor-and-seccomp-profiles-restricting-container-system-calls.md) · [↗ valtersit.com](https://www.valtersit.com/guides/security/apparmor-and-seccomp-profiles-restricting-container-system-calls/)
...
- [Who Created the Dark Web, and How Does It Actually Work?](security/what-is-the-dark-web.md) · [↗ valtersit.com](https://www.valtersit.com/who-created-and-what-is-the-dark-web-hidden-web-and-how-does-it-work/)
...
- [VictoriaMetrics: Drop-In Prometheus Replacement?](monitoring/victoriametrics-drop-in-prometheus-replacement.md) · [↗ valtersit.com](https://www.valtersit.com/guides/monitoring/victoriametrics-drop-in-prometheus-replacement/)
...
This repository is an automatically maintained mirror of technical guides published on [valtersit.com](https://www.valtersit.com). Each article links back to the full original version.

**Topics:** Cybersecurity · Docker · Kubernetes · Homelab · Networking · DevOps
